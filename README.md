...
The agent package version is `2.7.1`.
...
Requirements are .NET 10, `CSweet.Agent.SDK` 3.13.0, `CSweet.Memory`, an approved protocol-v2 installation, an active managing employee, and the grants in [GRANTS.md](GRANTS.md).
