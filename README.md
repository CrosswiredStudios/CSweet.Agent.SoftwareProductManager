...
First-party Software Product Manager agent for C-Sweet, built on `CSweet.Agent.SDK` 3.21.0 and manifest protocol v2.
The agent package version is `2.14.0`.
...
Requirements are .NET 10, `CSweet.Agent.SDK` 3.21.0, `CSweet.Memory`, an approved protocol-v2 installation, an active managing employee, and the grants in [GRANTS.md](GRANTS.md).
